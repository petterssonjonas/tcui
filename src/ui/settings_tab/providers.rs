...
pub(super) fn render_model_list_inline(&mut self, f: &mut Frame, area: Rect, dropdown: ProvidersDropdown) {
...
pub(super) fn render_providers_dropdowns(&mut self, f: &mut Frame, chunks: std::rc::Rc<[Rect]>) {
...
pub(super) fn render_provider_form_popup(f: &mut Frame, parent_area: Rect, form: &mut ProviderFormState) {
